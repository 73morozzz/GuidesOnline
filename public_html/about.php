			...
			<div class="inner">
				<div class="container">
					<div class="row aligned-cols">
						...
						<div class="col-sm-9">
							<p>Если вы собраетесь в путешествие в новый для вас город и не знаете, куда пойти и что посетить, то наш сервис именно дл¤ вас. Найдите здесь своего личного гида, который расскажет и покажет вам город, так, как никто его не видел. Етот гид, простой человек, живущий в этом городе, такую роль и вы можете взять на себя!
							</p>
						</div> <!-- end .col-sm-9 -->
					</div> <!-- end .row -->
				</div> <!-- end .container -->
		...
		<div class="section white">
			<div class="inner">
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<h2><small>Выйдите из зоны комфорта </small>сутешествуйте</h2>
							<p>Открывайте для себя новые точки на карте, узнавайте мир, знакомьтесь с историей города и с историями людьми, в котором они живут. Интересные факты и места, которых нет ни в одном путеводителе и все это совершенно бесплатно.</p>
							<p>Любой город, любая страна, когда-то бывшая неизвествой и негостеипримной станет вашим вторым домом. Забудьте о бумажных картах и путеводителях, ведь с вами есть я, сервис, который поможет вам найти проводника по самым извилистым улочкам нового города. </p>
						</div> <!-- end .col-sm-6 -->
						<div class="col-sm-6">
			...
			<div class="inner">
				<div class="container">
					<!--<div class="row">-->
						<div class="col-sm-6">
						<h2>Дарите добро</h2>
							<h3 style="width: 1000px;">Заводите новые знакомства, узнавайте мир и открывайте его для других людей</h3>
							<!--<p> Ћюбой человек может стать, как и √идом, так и простым туристом, который хочет увидеть мир, не с обыденного ракурса.</p>
						</div> <!-- end .col-sm-6 -->
					<!--	<div class="col-sm-6">
						<h2>≈ще один плюсы</h2>
							<h3><span class="highlight">02.</span> Ѕесплатность</h3>
							<p>ѕомогайте и люд¤м и будет вам счатье, ведь дарить добро это хорошо. — другой стороны, каждый </p>
						</div> <!-- end .col-sm-6 -->
					<!--</div> <!-- end .row -->
